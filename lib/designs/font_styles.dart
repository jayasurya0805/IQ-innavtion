...
class TextStyles {
  ...
  static const textdfontStyle = TextStyle(
    fontSize: 14,
  ...
  static const popupfontStyle = TextStyle(
    fontSize: 15,
    color: AppColors.popupfontgroundcolor,
    fontWeight: FontWeight.w600,
    fontFamily: 'Montserrat',
  );

  static const TextfieldFontStyle = TextStyle(
    fontSize: 15,
